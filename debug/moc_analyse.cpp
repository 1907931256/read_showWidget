...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Analyse_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 17, 8)
    ...
    "Analyse\0zoom_In\0\0zoom_Out\0"
};
...
const QMetaObject Analyse::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Analyse.data,
      qt_meta_data_Analyse,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Analyse.stringdata))
        return static_cast<void*>(const_cast< Analyse*>(this));
